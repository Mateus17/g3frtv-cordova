(function () {
  ...
  var iconFrontVideo = document.querySelector('.video-played-picto');

  iconFrontVideo.addEventListener('click', function() {
    if (myPlayer.paused) {
      iconFrontVideo.style.display = "none";
      myPlayer.play();
    } else {
      iconFrontVideo.style.display = "block";
      myPlayer.pause();
    }
  });
  ...
  setTimeout(function () {
    ...
    document.getElementById("duration_time").innerHTML = xDuration + ":" + yDuration;
  }, 1000);
